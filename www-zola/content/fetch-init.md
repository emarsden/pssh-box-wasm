...
Some sample URLs for testing: [init1.mp4](https://refapp.hbbtv.org/videos/spring_h265_v8/cenc/v2/i_wvcenc.mp4),
[init2.mp4](http://media.axprod.net/TestVectors/v6.1-MultiDRM/1/init.mp4).
